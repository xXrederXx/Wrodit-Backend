...
class CommentVoteServiceTest {
    ...
    void setup() {
        ...
        commentVoteService =
                new CommentVoteService(commentRepositoryMock, userRepositoryMock, commentsVoteRepositoryMock);
    ...
    void checkDeleteById_whenValid_thenSuccess() {
        ...
        when(commentsVoteRepositoryMock.findOne(any(Specification.class))).thenReturn(Optional.of(vote));
