...
class CommentServiceTest {
    ...
    {
        when(mockRepo.findAll(any(Specification.class) ,any(Pageable.class))).thenReturn(mockCommentPage);
    ...
    void checkUpdate_whenInvalidChanges_thenThrows()
    {
        ...
        assertThrows(FailedValidationException.class, ()->commentService.update(change, comment.getId(), user.getId()));
    }
    ...
    void checkUpdate_whenNoAuth_thenThrows()
    {
        ...
        assertThrows(AuthorizationDeniedException.class, ()->commentService.update(change, comment.getId(), user.getId() + 1));
    }
}
